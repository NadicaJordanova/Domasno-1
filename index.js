...
function pretvori(typeConvert) {
  return function (temp) {
    if (typeConvert == "c2f") {
      return (temp * 9) / 5 + 32;
    } else if (typeConvert == "f2c") return ((temp - 32) * 5) / 9;
  };
}
...
const proverka =
  vozrastNaCovek >= reperZaPolnoletnost ? "polnoleten" : "maloleten";
...
const filtriraniStudenti1 = studenti.map((student) => {
  return {
    ...student,
    prosek: student.prosek > 7 ? student.prosek + 1 : student.prosek,
  };
});
...
const array4 = [1, 2, 4, 5, 7];
// ne e kopija
console.log(array1 === array4);

const array2 = [1, 4, 6, 8, 3];
const array3 = array1;
// se mene vo memeorija i ne e kopija

const array5 = [...array1];
// kopija i ne se menuva vo memory
console.log(...array1);
console.log(array5);
...
// Destruction - razglobuvanje

const arr1 = [1, 2, 3, 6, 7, 8, 9, 10]
...
const {produkt: zelencuk, cena} = predmet
console.log(zelencuk, cena)

// namesto predmet.produkt koristeme produkt oti e razlozen
